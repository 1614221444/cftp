...
import com.createlt.sys.service.ISysUserService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        ...
        // 放行swagger框架API
        web.ignoring().antMatchers(HttpMethod.GET, "/doc.html", "/webjars/**", "/swagger-resources/**", "/v2/api-docs", "/websocket/*");
    }
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authenticationProvider.setUserDetailsService((UserDetailsService) sysUserService);
